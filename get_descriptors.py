...
#from rdkit import DataStructs use it for Tanimoto
...
# Important variables
mol2file = sys.argv[1]
observables = ["RD_Stereocenters", "RD_LogP", "RD_TPSA", "RD_SYNTHA", "RD_QED", "Grid_Score"]#, "Layer_Completed"]
#IMPORTANT COMMENT: If "Grid_Score" is not in the mol2 file, try to find "Continuous_Score".
# Be very careful and take precise notes of what you did, where and how.
